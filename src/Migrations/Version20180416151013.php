 ...
 */
class Version20180416151013 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE ausencia (id INT AUTO_INCREMENT NOT NULL, tipoausencia_id INT DEFAULT NULL, employeeausencia_id INT DEFAULT NULL, descricao VARCHAR(255) NOT NULL, dataini DATE DEFAULT NULL, datafim DATE DEFAULT NULL, INDEX IDX_4B573FB9204C663 (tipoausencia_id), INDEX IDX_4B573FB9B55749F (employeeausencia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE ausencia ADD CONSTRAINT FK_4B573FB9204C663 FOREIGN KEY (tipoausencia_id) REFERENCES tipoausencia (id)');
        $this->addSql('ALTER TABLE ausencia ADD CONSTRAINT FK_4B573FB9B55749F FOREIGN KEY (employeeausencia_id) REFERENCES employee (id)');
        $this->addSql('ALTER TABLE cidade CHANGE ufid ufid INT DEFAULT NULL');
        $this->addSql('ALTER TABLE documento CHANGE employee_id employee_id INT DEFAULT NULL, CHANGE path path VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE tipoausencia DROP dataini, DROP datafim');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE ausencia');
        $this->addSql('ALTER TABLE cidade CHANGE ufid ufid INT DEFAULT NULL');
        $this->addSql('ALTER TABLE documento CHANGE employee_id employee_id INT DEFAULT NULL, CHANGE path path VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8_unicode_ci');
        ...
        $this->addSql('ALTER TABLE tipoausencia ADD dataini DATE DEFAULT \'NULL\', ADD datafim DATE DEFAULT \'NULL\'');
    }
}
