 ...
 */
class Version20180410144744 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cidade ADD CONSTRAINT FK_6A98335CCF1F4D8F FOREIGN KEY (ufid) REFERENCES estado (id)');
        $this->addSql('CREATE INDEX IDX_6A98335CCF1F4D8F ON cidade (ufid)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cidade DROP FOREIGN KEY FK_6A98335CCF1F4D8F');
        $this->addSql('DROP INDEX IDX_6A98335CCF1F4D8F ON cidade');
        $this->addSql('ALTER TABLE cidade CHANGE ufid ufid INT DEFAULT NULL');
