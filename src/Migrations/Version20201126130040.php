 ...
 */
class Version20201126130040 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE chamado ADD CONSTRAINT FK_3B02066F5A91C08D FOREIGN KEY (departamento_id) REFERENCES lotacao (id)');
